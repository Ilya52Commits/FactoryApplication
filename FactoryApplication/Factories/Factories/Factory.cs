...
public class Factory(string nameFactory, string manufacturedProduct, double productionCoefficient)
  : AbstractFactory(nameFactory, manufacturedProduct, productionCoefficient)
{
  #region Свойства
  ...
  {
    return new Product(name, weidth, typeOfPackaging, NameFactory);
  }
